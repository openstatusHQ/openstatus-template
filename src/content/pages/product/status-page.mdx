...
You can attach specific monitors to a status page. You can either populate the data from the **aggregated uptime** data **or manually** manage them.

You can **group monitors** by their services, locations,... and they will be collabsible.

> We are aware that custom components are much in need. You can achieve it by having a **inactive monitors** on a **manual status page**.
