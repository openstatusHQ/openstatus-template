...
import type { RegionMetricsChartTable } from "@/data/region-metrics";
import { type Region, regions as regionDict } from "@/data/regions";
			...
			<table>
				...
				<tbody>
					{regions
						...
						.map((region) => {
							const regionConfig = regionDict.find((r) => r.code === region);
